...
},{"./cjs/react-reconciler.development.js":5,"./cjs/react-reconciler.production.min.js":6,"_process":2}],8:[function(require,module,exports){
(function (process){
    ...
    updatePayload.forEach(function (propName) {
      ...
      if (propName === 'style') {
        ...
        if (isEventName(propName)) {
          ...
          domElement.removeEventListener(_eventName, oldProps[propName]);
        } else {
...
var Banana = {
  render: function render(reactElement, domElement, callback) {
